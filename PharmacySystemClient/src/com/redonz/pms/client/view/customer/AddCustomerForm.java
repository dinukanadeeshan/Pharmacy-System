...
public class AddCustomerForm extends javax.swing.JDialog {
    ...
    /**
     *
     * This constructor is called in manage customer form to add new Customer
     * 
     * @param dialog parent dialog
     * @param modal that allows to access patent dialog
     */
    public AddCustomerForm(JDialog dialog, boolean b) {
        super(dialog, b);
        this.dialog = dialog;
        initComponents();
        setLocationRelativeTo(null);
...
//        contactTextField.setText("");
    ...
    private void setSaveButtonEnable() {
        boolean b = nameTextField.getText().isEmpty() || addressTextField.getText().isEmpty() ;
